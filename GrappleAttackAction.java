...
public class GrappleAttackAction extends PhysicalAttackAction {
    ...
    public static ToHitData toHit(IGame game, int attackerId, Targetable target, int grappleSide) {
        ...
        instanceOfMech(grappleSide, ae, toHit);

        notGrappleBoth(grappleSide, ae, toHit, te);
        
        // Weight class difference
        weightClassDifference(ae, toHit, te);
        // done!
        return toHit;
    }

	private static void notGrappleBoth(int grappleSide, final Entity ae, ToHitData toHit, Entity te) {
	...
	private static void instanceOfMech(int grappleSide, final Entity ae, ToHitData toHit) {
	...
	private static void weightClassDifference(final Entity ae, ToHitData toHit, Entity te) {
